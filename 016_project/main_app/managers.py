...
class VideoGameManager(models.Manager):
    ...
    def highest_rated_game(self):
        game_max_rating = self.aggregate(max_rating=Max('rating'))['max_rating']

        return self.get(rating=game_max_rating)

    def lowest_rated_game(self):
        game_min_rating = self.aggregate(min_rating=Min('rating'))['min_rating']

        return self.get(rating=game_min_rating)

    def average_rating(self):
        avg_rating = self.aggregate(current_avg_rating=Avg('rating'))['current_avg_rating']
