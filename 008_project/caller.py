...
from main_app.models import ArtworkGallery, Laptop, OperationSystemChoices, ChessPlayer, Meal, Dungeon, Workout
...
def delete_inexpensive_laptops():
    Laptop.objects.filter(price__ls=1200).delete()
